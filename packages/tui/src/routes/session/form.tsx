              ...
              <box>
                ...
                <Show when={custom()}>
                  ...
                  >
                    <box flexDirection="row">
                      <box
                        backgroundColor={other() ? themeV2.background.action.secondary("focused") : undefined}
                        paddingRight={1}
                      >
                        <text
                          fg={
                            other()
                              ? tint(themeV2.text.subdued(), themeV2.text.action.secondary(), 0.6)
                              : themeV2.text.subdued()
                          }
                        >
                          {`${rows().length + 1}.`}
                      ...
                      <box backgroundColor={other() ? themeV2.background.action.secondary("focused") : undefined}>
                        <text
                          fg={
                            other()
